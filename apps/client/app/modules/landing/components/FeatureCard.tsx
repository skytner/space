...
export function FeatureCard({
  ...
  return (
    <motion.div
      layoutId={enableLayoutAnimation ? `feature-${id}` : undefined}
      className={cn(
        "group relative w-full h-full min-h-full flex cusror-none",
        className,
      )}
    ...
    >
      ...
      <Card className="relative w-full h-full overflow-hidden rounded-[21px] border-none bg-[#010309]/95 md:backdrop-blur-3xl p-8 md:p-10 flex flex-col items-start justify-between flex-1">
        <motion.div
